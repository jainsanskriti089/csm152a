...
HD_PWD='C:/Users/Student/Desktop/SanskritiAnusha/lab0/lab0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log combinational_gates_muxed.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source combinational_gates_muxed.tcl -notrace
