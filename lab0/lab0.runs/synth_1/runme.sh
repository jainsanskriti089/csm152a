...
HD_PWD='C:/Users/Student/Desktop/SanskritiAnusha/lab0/lab0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log combinational_gates_muxed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source combinational_gates_muxed.tcl
